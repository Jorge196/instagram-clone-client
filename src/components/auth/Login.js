  ...
  render() {
    return (
      ...
      >
        ...
        <fieldset>
          <label className='block uppercase mb-2' forhtml='email'>
            Email:
          </label>
          <input
            type='text'
        ...
        <fieldset>
          <label className='block uppercase mb-2' forhtml='password'>
            Password:
          </label>
          <input
            type='password'
        ...
        <input
          className='w-full text-center uppercase p-4 bg-purple-300 cursor-pointer mt-4'
          type='submit'
          value='Log In'
        />
      </form>
